  ...
  const PropertySizeInfo = () => {
    ...
    return (
      <div className="property-size-info">
        ...
        {pricePerSqm && (
          <div className="size-item price-per-sqm" title="Price per square meter - Calculated using property value estimate or listing price when estimate is unavailable. For price ranges, the average of low and high values is used.">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
